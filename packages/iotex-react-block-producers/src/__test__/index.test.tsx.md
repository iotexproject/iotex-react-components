                ...
                >
                  ...
                  >
                    <div
                      style={
                        {
                          backgroundImage: 'linear-gradient(to right, rgba(245,167,30,1), rgba(255,208,80,1))',
                          height: '100%',
                          width: '2px',
                        }
                      }
                    ...
                    <div
                      style={
                        {
                          backgroundImage: 'linear-gradient(to right, rgba(245,167,30,0.5), rgba(255,208,80,0.5))',
                          height: '100%',
                          marginLeft: '1px',
                          width: '1px',
                        }
                    ...
                    <div
                      style={
                        {
                          alignItems: 'center',
                          backgroundImage: 'linear-gradient(to right, rgba(245,167,30,0.1), rgba(255,208,80,0))',
                          display: 'flex',
                          height: '100%',
                          justifyContent: 'flex-end',
                          paddingRight: '4px',
